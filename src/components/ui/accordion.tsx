...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="!m-0 flex text-base">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex flex-1 items-center justify-between p-4 py-4 font-medium transition-all  hover:bg-zinc-100 dark:hover:bg-zinc-900 [&[data-state=open]>svg]:rotate-180 [&[data-state=open]]:rounded-b-none',
        className
      )}
      {...props}
    >
